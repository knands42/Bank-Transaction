...
// Source: app/internal/db/sqlc/store.go
...
func (m *MockQuerier) CreateEntry(ctx context.Context, arg sqlc.CreateEntryParams) (sqlc.Entry, error) {
	m.ctrl.T.Helper()
...
func (m *MockQuerier) GetEntry(ctx context.Context, id int64) (sqlc.Entry, error) {
	m.ctrl.T.Helper()
...
func (m *MockQuerier) GetUser(ctx context.Context, username string) (sqlc.User, error) {
	m.ctrl.T.Helper()
...
func (m *MockQuerier) ListAccounts(ctx context.Context, arg sqlc.ListAccountsParams) ([]sqlc.Account, error) {
	m.ctrl.T.Helper()
...
func (m *MockQuerier) ListEntries(ctx context.Context, arg sqlc.ListEntriesParams) ([]sqlc.Entry, error) {
	m.ctrl.T.Helper()
...
func (m *MockQuerier) UpdateAccount(ctx context.Context, arg sqlc.UpdateAccountParams) (sqlc.Account, error) {
	m.ctrl.T.Helper()
